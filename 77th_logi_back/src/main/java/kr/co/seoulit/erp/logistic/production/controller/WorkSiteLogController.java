...
public class WorkSiteLogController {
     ...
     **************************************/
    @Operation(summary = "작업장 로그 조회")
    @RequestMapping(value = "/getProductionProcessCode", method = RequestMethod.GET)
    @ResponseBody
    public ResponseEntity<List<WorkSiteLog>> getWorkSiteLog(@RequestParam @Parameter(description = "생산공정코드")String productionProcessCode,
                                                            @RequestParam @Parameter(description = "사업장명")String workSiteName) {
