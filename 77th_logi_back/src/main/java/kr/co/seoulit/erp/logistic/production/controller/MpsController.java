...
public class MpsController {
	...
	/*****************************
		 MPS 등록가능 수주 조회
	 *****************************/
	@Operation(summary = "MPS 등록가능 수주 조회")
	 ...
	 *****************************/
	@Operation(summary = "MPS 등록가능 판매계획 조회(JPA)")
	...
	public void convertSalesPlanToMps(@RequestBody SalesPlan salesPlan) {
		System.out.println("salesPlan " + salesPlan);
	...
	/*****************************
	 차트용 MPS 테이블 조회
	 *****************************/
	@Operation(summary = "차트용 MPS 테이블 조회")
