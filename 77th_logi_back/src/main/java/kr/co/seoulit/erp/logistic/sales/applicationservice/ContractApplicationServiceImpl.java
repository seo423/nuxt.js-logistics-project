...
//
	...
	public HashMap<String, Object> addNewContract(String contractDate, String personCodeInCharge,
			ContractTO workingContractBean, ArrayList<EstimateDetailTO> estimateDetailArray, String shipmentCompletionStatus) {
		System.out.println("ContractApplicationServiceImpl.addNewContract");
		System.out.println("ContractTO" + workingContractBean.getContractDetailTOList());
		//69기 VUE프로젝트에서 추가
		...
		workingContractBean.setShipmentCompletionStatus(shipmentCompletionStatus);
