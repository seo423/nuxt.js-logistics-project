...
//    @Operation(summary = "반품요청 수정")
//    @PutMapping("/updateReturn")
//    public void updateReturn(@RequestBody @Parameter(description = "반품JSON") ReturnTO returnList) {
//        salesSF.updateReturn(returnList);
//    }

    @Operation(summary = "반품재고요청 취소")
    @DeleteMapping(value = "/deleteReturnStock/{rtrnRecNo}")
    public void deleteReturnStock(@PathVariable @Parameter(description = "반품JSON") String rtrnRecNo) {
