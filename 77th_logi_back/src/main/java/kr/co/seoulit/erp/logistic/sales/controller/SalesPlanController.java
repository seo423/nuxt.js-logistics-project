...
public class SalesPlanController {
	...
	/*판매계획조회*/
	@Operation(summary = "날짜에 따른 판매계획 조회")
	@GetMapping(value = "/searchSalesPlanByDate")
	public ModelMap findSalesPlanByDate(@RequestParam("startDate") String startDate, @RequestParam("endDate") String endDate){
		List<SalesPlane> salesPlanByDateList = salesSF.findSalesPlanByDate(startDate,endDate);
		modelMap.put("gridRowJson", salesPlanByDateList);
		modelMap.put("errorCode", 1);
		modelMap.put("errorMsg", "성공");
		return modelMap;
	}
