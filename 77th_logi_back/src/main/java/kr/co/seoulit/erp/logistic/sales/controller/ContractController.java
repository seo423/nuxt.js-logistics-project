...
public class ContractController {
	...
	@Operation(summary = "수주로 등록 가능한 견적목록 검색 ")
	...
	public HashMap<String, Object> addNewContract(@RequestBody Map<String, Object> paramList) {
		...
		String shipmentCompletionStatus = paramList.get("shipmentCompletionStatus").toString();
		...
		resultMap = salesSF.addNewContract(contractDate, personCodeInCharge, workingContractTO, estimateDetailArray, shipmentCompletionStatus);
